...
final class Version20220114095653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, personal_account VARCHAR(180) NOT NULL, roles VARCHAR(255) NOT NULL COMMENT \'(DC2Type:json)\'
